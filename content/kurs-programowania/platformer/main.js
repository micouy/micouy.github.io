...
function preload() {
    // załaduj obrazy
    this.load.image('p1_walk01', 'p1_walk01.png');
    this.load.image('p1_walk02', 'p1_walk02.png');
    this.load.image('p1_walk03', 'p1_walk03.png');
    this.load.image('p1_walk04', 'p1_walk04.png');
    this.load.image('p1_walk05', 'p1_walk05.png');
    this.load.image('p1_walk06', 'p1_walk06.png');
    this.load.image('p1_walk07', 'p1_walk07.png');
    this.load.image('p1_walk08', 'p1_walk08.png');
    this.load.image('p1_walk09', 'p1_walk09.png');
    this.load.image('p1_walk10', 'p1_walk10.png');
    this.load.image('p1_walk11', 'p1_walk11.png');

    this.load.image('slime_walk01', 'slime_walk01.png');
    this.load.image('slime_walk02', 'slime_walk02.png');
